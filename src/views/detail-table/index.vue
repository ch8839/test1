              ...
              <template slot-scope="props">
                ...
                <div class="drop-container">
                  <div class="table2-container">
                    <el-table :data="props.row.labGround_element" class="drop_table"
                      :row-class-name="tableRowClassName">
                      <el-table-column label="指标">
                        <template slot-scope="scope">
                          <span
                            :class="{pollution: scope.row.ispollution}">{{ element_Map.get(scope.row.element) }}</span>
                        </template>
                      </el-table-column>
                      <el-table-column label="数值">
                        <template slot-scope="scope">
                          <span
                            :class="{pollution: scope.row.ispollution}">{{ handleElementValue(scope.row.value) }}</span>
                        </template>
                      </el-table-column>
            ...
            <el-table-column label="污染物" align="center">
              <template slot-scope="scope">
                ...
                <template v-if="handlePollutionList(scope.row.labGround_element).length">
                  <el-tag type="danger" v-for="(item,index) in handlePollutionList(scope.row.labGround_element)"
          ...
          <el-table v-loading="listLoading2" :data="lab_water_list" border stripe style="width: 100%">
            <el-table-column type="expand">
              <template slot-scope="props">
                <div class="drop-container">
                  <div class="table2-container">
                    <el-table :data="props.row.labWater_element" class="drop_table" :row-class-name="tableRowClassName">
                      <el-table-column label="指标">
                        <template slot-scope="scope">
                          <span
                            :class="{pollution: scope.row.ispollution}">{{ element_Map.get(scope.row.element) }}</span>
            ...
            <el-table-column label="污染物" align="center">
              <template slot-scope="scope">
                ...
                <template v-if="handlePollutionList(scope.row.labWater_element).length">
                  <el-tag type="danger" v-for="(item,index) in handlePollutionList(scope.row.labWater_element)"
                    :key="index">{{element_Map.get(item.element)}}</el-tag>
                </template>
                <template v-else>
                  <el-tag type="success">无污染元素</el-tag>
